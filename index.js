...
for(let i=0;i<platinum.length;i++){
    platinumImages+=`<a href='${platinum[i].url}' target='_blank'><img src='platinum/${platinum[i].fileName}' alt=""></a>`
}
...
for(let i=0;i<gold.length;i++){
    goldImages+=`<a href='${gold[i].url}' target='_blank'><img src='gold/${gold[i].fileName}' alt=""></a>`
}
...
for(let i=0;i<silver.length;i++){
    silverImages+=`<a href='${silver[i].url}' target='_blank'><img src='silver/${silver[i].fileName}' alt=""></a>`
}
